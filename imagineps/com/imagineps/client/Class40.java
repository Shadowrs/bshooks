...
final class Class40 {
    ...
    public Class40(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3, int j3, int k3, int l3, int i4, int k4, int l4) {
        ...
        for (int k6 = 0; k6 < l5; ++k6) {
            ...
            this.anIntArray673[k6] = i7;
            this.anIntArray674[k6] = i8;
            this.anIntArray675[k6] = k7;
            ai1[k6] = k8;
            ai2[k6] = j9;
        }
        ...
        for (int j8 = 0; j8 < j7; ++j8) {
            ...
            this.anIntArray679[j8] = k9;
            this.anIntArray680[j8] = i10;
            this.anIntArray681[j8] = k10;
            if (l8 == 0) {
                this.anIntArray676[j8] = ai1[k9];
                this.anIntArray677[j8] = ai1[i10];
                this.anIntArray678[j8] = ai1[k10];
                if (this.anIntArray682 == null) continue;
                this.anIntArray682[j8] = -1;
                continue;
            }
            this.anIntArray676[j8] = ai2[k9];
            this.anIntArray677[j8] = ai2[i10];
            this.anIntArray678[j8] = ai2[k10];
            if (this.anIntArray682 == null) continue;
            this.anIntArray682[j8] = i1;
        }
        int i9 = i3;
        int l9 = l2;
        if (l2 < i9) {
